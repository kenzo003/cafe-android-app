package com.example.cafe.screens.auth.passcodeview;
...
import static com.example.cafe.screens.auth.passcodeview.PasscodeView.PasscodeViewType.TYPE_CHECK_PASSCODE;
import static com.example.cafe.screens.auth.passcodeview.PasscodeView.PasscodeViewType.TYPE_SET_PASSCODE;
...
public class PasscodeView extends FrameLayout implements View.OnClickListener {
    ...
    private String firstInputTip = "Введите код доступа";
    private String secondInputTip = "Введите новый пароль еще раз";
    private String wrongLengthTip = "Введите код доступа";
    private String wrongInputTip = "Код доступа не совпадает";
    ...
    public PasscodeView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        firstInputTip = firstInputTip == null ? "Введите код доступа" : firstInputTip;
        secondInputTip = secondInputTip == null ? "Введите код еще раз" : secondInputTip;
        wrongLengthTip = wrongLengthTip == null ? firstInputTip : wrongLengthTip;
        wrongInputTip = wrongInputTip == null ? "Код доступа не совпадает" : wrongInputTip;
        correctInputTip = correctInputTip == null ? "Код введен верно" : correctInputTip;
